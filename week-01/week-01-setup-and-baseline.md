...
| AI Setup Survey     | 20 min         |
| Partner sync        | 15–30 min      |
| Slack participation | 5–10 min       |
| **Total**           | **~45–60 min** |

## Supporting Materials

- [ ] [AI Setup Survey](../templates/setup-survey.md)
...
```
Have you DM'd your partner? Emoji here when done. 👇
```

#### Wednesday

```
Have you set up a recurring 15–30 minute sync with your partner yet?
Emoji here when done. 👇
```

#### Thursday

```
What's one interesting thing about your AI setup? 👇
```
...
- Your partner is your check-in buddy, not an evaluator
- Schedule 15–30 min together every week
- Share learnings, ask questions, support each other

### 8:00–10:00 — What's Next

- Survey due Friday 5pm PST
- Friday: I'll share anonymized cohort findings
- Week 2 preview: No Vibe Coding rules
- How to reach me: Slack `#ai-pilot-cohort` for visibility, please no DMs!
